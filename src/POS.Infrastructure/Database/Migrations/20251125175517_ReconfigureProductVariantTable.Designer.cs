...
namespace POS.Infrastructure.Database.Migrations
{
    ...
    [Migration("20251125175517_ReconfigureProductVariantTable")]
    partial class ReconfigureProductVariantTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("POS.Domain.Products.ProductVariant", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("PackageSize", "POS.Domain.Products.ProductVariant.PackageSize#Measurement", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Packaging", "POS.Domain.Products.ProductVariant.Packaging#Packaging", b1 =>
                        {
                            b1.IsRequired();
